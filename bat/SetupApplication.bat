...
:: Android packaging
set AND_CERT_NAME="ScavengerMobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\ScavengerMobile.p12
...
set IOS_PROVISION=cert\ScavengerMobile.mobileprovision
...
set APP_ID=air.ScavengerMobile

:: Output packages
set DIST_PATH=dist
set DIST_NAME=ScavengerMobile
